...
cont_rate_filter = (cont_rate_filter < 0.5) | (unit_type == 'multiunit')
presence_rate_filter = presence_rate_filter > 0.8
...
for neuron in neuron_list:  # fit units loop
    ...
    savemat('%s_fit_info_results_t_sac.mat'%session,mdict={'pgam_results':regr_res})
