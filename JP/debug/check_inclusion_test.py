...
for row in table:
    ...
    for inputs in construct_knots(gam_raw_inputs, counts, var_names, dict_param,trialCathegory_spatial=True):
    ...
    np.savez('firing_hz.npz',pval_prior=pval_prior,neu_fit=neu_fit,firing_hz=firing_hz,cov_sign=cov_sign)
