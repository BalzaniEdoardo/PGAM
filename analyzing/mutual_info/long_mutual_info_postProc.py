...
if os.path.exists('/Users/edoardo/Work/Code/GAM_code/GAM_library'):
    ...
    folder_fh = '/Volumes/WD_Edo/firefly_analysis/LFP_band/fit_longFilters/'
    ...
    folder_fh = '/scratch/jpn5/fit_longFilters/'
    done_folder = '/scratch/jpn5/mutual_info_long/done'
    folder_incomplete = '/scratch/jpn5/mutual_info_long/incomplete'
    is_clust = True
