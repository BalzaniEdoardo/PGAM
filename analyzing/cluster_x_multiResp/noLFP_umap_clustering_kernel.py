...
for n_neighbors in [20, 40, 50, 100]:
    ...
    plt.scatter(umap_res[brain_area == 'PFC', 0],
                umap_res[brain_area == 'PFC', 1], s=10, c='r', alpha=0.9)

    plt.scatter(umap_res[brain_area == 'MST', 0],
                umap_res[brain_area == 'MST', 1], s=10, c='g', alpha=0.9)
...
ax_scatter.scatter(umap_res[brain_area == 'PPC', 0],
            umap_res[brain_area == 'PPC', 1], s=10, c='b', alpha=0.4)
ax_scatter.scatter(umap_res[brain_area == 'PFC', 0],
            umap_res[brain_area == 'PFC', 1], s=10, c='r', alpha=0.9)
ax_scatter.scatter(umap_res[brain_area == 'MST', 0],
            umap_res[brain_area == 'MST', 1], s=10, c='g', alpha=0.9)
ax_scatter.scatter(umap_res[brain_area == 'VIP', 0],
            umap_res[brain_area == 'VIP', 1], s=10, c='k', alpha=0.9)

ax_scatter.legend()

ax_histx.hist(umap_res[brain_area == 'PPC', 0], bins=10,color='b',alpha=0.4,density=True)
ax_histx.hist(umap_res[brain_area == 'PFC', 0], bins=10,color='r',alpha=0.5,density=True)
ax_histx.hist(umap_res[brain_area == 'MST', 0], bins=10,color='g',alpha=0.5,density=True)
...
ax_histy.hist(umap_res[brain_area == 'PPC', 1], bins=10,color='b',alpha=0.5,density=True,orientation='horizontal')
ax_histy.hist(umap_res[brain_area == 'PFC', 1], bins=10,color='r',alpha=0.5,density=True,orientation='horizontal')
ax_histy.hist(umap_res[brain_area == 'MST', 1], bins=10,color='g',alpha=0.5,density=True,orientation='horizontal')
...
ax_histy.set_xticks([])
plt.savefig('tuning_umap_noLFP.png')
...
plt.savefig('noLFP_umap_dim_reduction.png')
...
savemat('noLFP_hdbscan_umap_kernel.mat',mdict=mdict)
np.save('noLFP_hdbscan_umap_kernel.npy',mdict)
