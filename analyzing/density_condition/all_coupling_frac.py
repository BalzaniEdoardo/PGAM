...
# sel monkey
coupl_info = coupl_info[(coupl_info['pseudo-r2']>=0.01)]
...
sel = (coupl_info['manipulation value']== True) * (coupl_info['manipulation type'] == 'all') * (coupl_info['sender brain area'] == 'MST') * (coupl_info['receiver brain area'] == 'PPC')
...
sel = (coupl_info['manipulation value']== True) * (coupl_info['manipulation type'] == 'all') * (coupl_info['sender brain area'] == 'MST') * (coupl_info['receiver brain area'] == 'PFC')
betw_coupl = coupl_info[sel]
...
sel = (coupl_info['manipulation value']== True) * (coupl_info['manipulation type'] == 'all') * (coupl_info['sender brain area'] == 'PPC') * (coupl_info['receiver brain area'] == 'PFC')
betw_coupl = coupl_info[sel]
...
sel = (coupl_info['manipulation value']== True) * (coupl_info['manipulation type'] == 'all') * (coupl_info['sender brain area'] == 'PFC') * (coupl_info['receiver brain area'] == 'PPC')
betw_coupl = coupl_info[sel]
...
sel = (coupl_info['manipulation value']== True) * (coupl_info['manipulation type'] == 'all') * (coupl_info['sender brain area'] == 'PPC') * (coupl_info['receiver brain area'] == 'MST')
betw_coupl = coupl_info[sel]
...
sel = (coupl_info['manipulation value']== True) * (coupl_info['manipulation type'] == 'all') * (coupl_info['sender brain area'] == 'PFC') * (coupl_info['receiver brain area'] == 'MST')
betw_coupl = coupl_info[sel]
