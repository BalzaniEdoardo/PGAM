...
lnreg = sts.linregress(tabular_results[bl]['coupling_strength_delta'],tabular_results[bl]['mutual_info'])
plt.scatter(tabular_results[bl]['coupling_strength_delta'],tabular_results[bl]['mutual_info'],color='g')

xlim = np.array(plt.xlim())
plt.plot(xlim, lnreg.slope*xlim + lnreg.intercept,'g')

yy_true = tabular_results[bl]['mutual_info']
...
plt.scatter(tabular_results[bl]['coupling_strength_delta'],tabular_results[bl]['mutual_info'],color='b')
xlim = np.array(plt.xlim())
...
plt.scatter(tabular_results[bl]['coupling_strength_delta'],tabular_results[bl]['mutual_info'],color='r')
xlim = np.array(plt.xlim())
