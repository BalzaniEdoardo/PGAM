...
if not cluster:
    path_to_gam = '/Volumes/WD_Edo/firefly_analysis/LFP_band/lfp_fit_results'
    npz_path = '/Volumes/WD_Edo/firefly_analysis/LFP_band/concatenation_with_accel/'

else:
    path_to_gam = '/scratch/jpn5/lfp_fit/lfp_fit_results'
...
pattern = '^LFP_fit_results_m\d+s\d+_c\d+_[a-z]+_\d+.\d\d\d\d.dill$'
