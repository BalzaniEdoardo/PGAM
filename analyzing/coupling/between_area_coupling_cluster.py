...
# np.savez('dbscan_fit.npz',dbscan_results=dbscan, tsne_results=tsne,tsne_transf=transf,zscore_filt=mat_filters)
...
mat_filters = dat['zscore_filt']

fig = plt.figure(figsize=[6., 6.  ])
grid = plt.GridSpec(6, 3, wspace=0.4, hspace=0.3)
...
mat_dict = {'cluster_labels':dbscan.labels_,'zscore_filt':mat_filters,
            'raw_filters_and_info':res_mat,'tsne_projection':transf}

savemat('cluster_filters.mat',mdict=mat_dict)