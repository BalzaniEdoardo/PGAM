...
np.save('decoding_rad_vel_with_subsamp.npy', score_session)
  
      
plt.figure()
plt.title('Decoding radial velocity\n PFC R^2 - PPC R^2')
...
plt.savefig('PFC_vs_PPC_rad_vel_decoding_deltaR2.pdf')

plt.figure()
plt.title('Decoding radial radial velocity')
...
plt.savefig('PFC_vs_PPC_rad_vel_decoding.pdf')
