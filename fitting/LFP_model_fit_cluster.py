...
try:
    ...
    folder_name = ''
    sv_folder_base = ''
    fhName = os.path.join('/Volumes/WD_Edo/firefly_analysis/LFP_band/concatenation_with_accel/','m53s93.npz')
...
for neuron in neuron_list:
    ...
    with open('gam_%s/LFP_fit_results_%s_c%d_%s_%.4f.dill'%(session,session,neuron,cond_type,cond_value),'wb') as fh:
