...
for neuron in neuron_list:
    ...
    full_PL, reduced_PL = gam_model.fit_full_and_reduced(sm_handler.smooths_var, th_pval=0.001, method='L-BFGS-B', tol=1e-8,
    ...
    modelX_test, idx_dict_test = sm_handler_test.get_exog_mat(full_PL.var_list)
    spk = yt[keep_test,neuron-1]
    p_r2_PL = pseudo_r2_compute(spk,family, modelX_test,full_PL.beta)
