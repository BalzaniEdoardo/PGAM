...
if plot_boolean:
    ...
    for unit in unit_list:#dill_name in os.listdir('/Volumes/WD_Edo/firefly_analysis/LFP_band/GAM_fit_with_acc/gam_%s/'%session):
        ...
        try:
            ...
            with open('/Users/edoardo/Work/Code/GAM_code/fitting/gam_m53s113/rad_pathComp_m53s113_c49_all_1.0000.dill','rb') as fh:
                resdict = dill.load(fh)
            result_dict2 = resdict['xy']
            result_dict = resdict['cumsum']
        ...
        lab_red = 'new rad_path'
        fit_slow = result_dict['full']
        lab_ful = 'old rad_path'
        ...
        xxdict['rad_path'] = xxdict['rad_path_from_xy']
        ...
        xxdict_slow['rad_path_from_xy'] = xxdict['rad_path']
        ...
        plt.savefig('checkPath_%s_c%d.png'%(session,unit))
        # plt.close('all')
        # plt.legend()
