...
for varType in var_dict.keys():
    for varName in var_dict[varType]:
        ...
        is_temporal_kernel, penalty_type, der = construct_knots_lowSpatialDensity(dat, varType, varName, neuNum=neuNum, portNum=portNum)
...
np.savez('lowDens_spatial_neuron_%d_fit.npz'%neuNum, results=results, filter_trials=filter_trials)
