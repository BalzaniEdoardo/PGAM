...
sign_mat = np.zeros(len(sess_list)*4,dtype={'names':['session','brain_area']+var_order,
...
plt.xlim(xlim)
plt.tight_layout()
plt.savefig('/Volumes/WD_Edo/firefly_analysis/LFP_band/FINALFIG/Figure2/raw_pdf/frac_tuned_SEM.pdf')
