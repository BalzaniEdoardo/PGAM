...
class get_paths_class(object):
    def __init__(self):
        ...
        self.cluster_data_basepath_array = '/Volumes/server/Data/Monkey2_newzdrive/%s/neural data/Sorted'
        
        # path to the monkey info folder
        monkey_info_path = '/Users/edoardo/Work/Code/GAM_code/preprocessing_pipeline/util_preproc/'
        # path to sorted
